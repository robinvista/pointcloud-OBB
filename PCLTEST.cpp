...
int main(int argc, char* argv[])
{
    ...
    reader.read("pointclouds.ply", *cloud);
	...
	pcl::visualization::PointCloudColorHandlerCustom<PointType> handler_1(cloud_cluster, 0, 255, 0); //转换到原点的点云相关
	pcl::visualization::PointCloudColorHandlerCustom<PointType> handler_2(transformedCloud, 255, 0, 0);  //输入的初始点云相关
